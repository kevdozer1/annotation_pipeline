...
2. Get real SAM/VDA/CoTracker perceptive rows passing `perceptive_status --require-real`, then run the preregistered pi0.7-vs-perceptive head-to-head.
